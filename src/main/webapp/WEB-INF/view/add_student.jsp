				...
				<div class="card">
					...
					<div class="card-body">
						<form action="createStudent" method="post">
							...
							<div class="mb-3">
								<label>Enter Roll Number</label> <input type="text" name="password"
									class="form-control">
							</div>

							<div class="mb-3">
								<label>Enter Standard</label> <input type="text"
									name="designation" class="form-control">
							</div>

							<div class="mb-3">
								<label>Enter Division</label> <input type="text" name="salary"
									class="form-control">
							</div>
